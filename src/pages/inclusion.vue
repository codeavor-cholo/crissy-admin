<template>
    <q-page padding>
        <div class="row justify-between q-pt-md">
            ...
            <div class="q-pr-xl">    
                <q-input dense v-model="filter" clearable type="text" label="Search Inclusion" color="orange-6" class="bg-white" outlined icon="search">
                                            ...
                                            <q-list>
                                                <q-item>
                                                    <q-item-section class="text-center">
                                                        <q-item-label style="font-size:17px"><b>{{props.row.inclusion}}</b></q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                            </q-list>
                                            <q-separator  inset />
