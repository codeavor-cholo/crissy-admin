<template>
    <q-page padding>
        ...
        <q-page-sticky position="bottom-right" :offset="[80, 50]">
            <q-btn label="Add New City" icon="add" color="accent" @click="addCityDialog = true, isEdit = false" />
                <q-tooltip>
                    Add City
                </q-tooltip>
        </q-page-sticky>
        ...
        <q-dialog v-model="addCityDialog" persistent>
            <q-card style="min-width: 400px">
                ...
                <q-card-section>
                    <q-input class="q-ma-sm" outlined color="purple" v-model="city" label="City"/>
                </q-card-section>

                <q-card-actions align="right" class="text-primary">
                    <q-btn flat style="color: #010A43" label="Cancel" @click="clear" v-close-popup/>
                    <q-btn v-if="!isEdit" flat color="purple" label="Add City" v-close-popup @click="addCity"/>
                    <q-btn v-if="isEdit" flat label="Update City" style="color: #FFC2C2" v-close-popup v-on:click="setTask"/>
                </q-card-actions>
            </q-card>
        </q-dialog>
    </q-page>
